-- character name =  {{specific insult, same specific insult}, {insult 2, still insult2}}
...
return {
  ...
  pierce = {{'You are one of the biggest disappointments to the name of Hawkthorne.', 'You will never be accepted in our family.'}},
  ...
  vicedean = {{'You are an overweight man who cant get a grip on his life, let alone his school.', 'You cant tell a difference between a right-hand man and a murderer.'}},
  ...
  vaughn = {{'You are a miniscule-nippled wannabe-rebel who asks the sky for help.', 'You constantly sing about meaningless feelings that Im surprised even YOU care about.'}},
  duncan = {{'You are a British slob, sticking your rod in anything that remotely resembles a woman.', 'You cant even teach a single class without a drink.'}},
  rich = {{'You are a flawed pretty boy who thinks that by being as successful', 'as you can be you might be able to win back the heart of a mother who never loved him in the first place.'}},
