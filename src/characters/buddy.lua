...
function plyr.new(sheet)
    ...
    new_plyr.animations = {
        ...
        attackjump = {
            left = anim8.newAnimation('loop', g('2-4,11'), 0.16),
            right = anim8.newAnimation('loop', g('2-4,10'), 0.16),
        },
        attackwalk = {
            left = anim8.newAnimation('loop', g('2-4,9'), 0.16),
            right = anim8.newAnimation('loop', g('2-4,8'), 0.16),
        },
        ...
        wieldaction2 = { --another state for swinging a weapon
            left = anim8.newAnimation('once', g('1-4,9'), 0.09),
            right = anim8.newAnimation('once', g('1-4,8'), 0.09),
        },
        jump = {
