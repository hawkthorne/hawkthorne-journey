...
local position_matrix_main = require 'positions/vicedean'
...
function plyr.new(sheet)
    ...
    new_plyr.animations = {
        ...
        wieldwalk = { --state for walking while holding a weapon
            left = anim8.newAnimation('loop', g('4-6,8','5,8'), 0.16),
            right = anim8.newAnimation('loop', g('4-6,7','5,7'), 0.16),
        },
        ...
        wieldaction = { --state for swinging a weapon
            left = anim8.newAnimation('once', g('4,8','6,8','3,8','6,8'), 0.09),
            right = anim8.newAnimation('once', g('4,7','6,7','3,7','6,7'), 0.09),
        },
        jump = {
