...
function splash:enter(a)
    ...
    self.text = string.format( i18n:get('s_or_s_select_item'), controls.getKey('JUMP'), controls.getKey('ATTACK') )
...
function splash:draw()
    ...
    for n,option in ipairs(self.menu.options) do
        love.graphics.print(i18n:get(option), x + 23, y + 12 * n - 2, 0, 0.5, 0.5)
    end
