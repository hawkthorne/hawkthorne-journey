...
state.zones = {
    ...
    town_3   = { x=51,  y=76,  UP=nil,        DOWN=nil,        RIGHT='town_2',   LEFT='town_4',   name='Village Forest',     level='village-forest'                                           },
    town_4   = { x=37,  y=76,  UP='valley_1', DOWN=nil,        RIGHT='town_3',   LEFT=nil,        name='Forestcave',         level='forestcave'                                     },
